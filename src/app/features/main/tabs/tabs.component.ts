  ...
  template: `
    <ion-tabs>
      <ion-tab-bar slot="bottom" class="bg-white dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800">
        ...
        <ion-tab-button tab="history" class="text-slate-500 dark:text-slate-400 focus:text-indigo-600 dark:focus:text-indigo-400 transition-colors">
        ...
        <ion-tab-button tab="boutiques" class="text-slate-500 dark:text-slate-400 focus:text-indigo-600 dark:focus:text-indigo-400 transition-colors">
...
export class TabsComponent {
  ...
  constructor() {
    addIcons({ homeOutline, mapOutline, timeOutline, personOutline, qrCodeOutline });
  }
}
